...
public class ModuleRepository implements CrudRepository<Module> {
    ...
    //SQL statement to insert a new module into the database
    private static final String SQL_INSERT = """
            INSERT INTO modulo (codigo, nombre, horas)
            VALUES (?, ?, ?)
            """;

    // SQL statement to retrieve all modules
    private static final String SQL_FINDALL = """
            SELECT *
            FROM modulo
            """;

    // SQL statement to find a module by its ID
    ...
    // SQL statement to update an existing module
    ...
    // SQL statement to delete a module by ID
    private static final String SQL_DELETE = """
            DELETE FROM modulo
            WHERE id_modulo = ?
            """;

    // Custom PostgreSQL driver for database connection management
    ...
    public Module insert(Module m) {
        ...
        try (Connection conn = postgresqlDriver.getConnection();
             // prepared statement configured to retrieve generated primary key
    ...
    public Module findById(int id) {
        ...
        try {
            ...
            try { if (ps != null) ps.close(); } catch (SQLException e) { log.warn("Error closing PreparedStatement", e); }
        }
    }
